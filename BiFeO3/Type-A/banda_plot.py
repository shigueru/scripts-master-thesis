...
fermi = 10.8958 # energia de fermi
band_out = "BiFeO3.ext-band-gen.out" # archivo .out del programa bands.x que estrae las bandas
band_dat = "BiFeO3.bandas.general.gnu" # archivo procesado de las bandas (archivo.gnu)
